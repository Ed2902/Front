// src/modules/Financiera/FactCompra/FormAbono.jsx
...
const FormAbono = ({ facturaId, factura, abonoIndex = 0, onSuccess }) => {
  ...
  const guardar = async () => {
    ...
    try {
      ...
      // 1) PUT JSON
      await actualizarAbonosFactCompra(facturaId, [abono], token)
      ...
      if (files.length) {
        ...
        await subirSoportesAbono(facturaId, abonoIndex, formData, token)
      }
      ...
      <div className='d-flex justify-content-between align-items-start mb-2'>
        <div>
          ...
          <div className='text-muted' style={{ fontSize: 12 }}>
            Factura: <strong>{factura?.factura || '-'}</strong> · Proveedor:{' '}
