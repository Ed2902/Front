// src/components/Shared/SecureHistorialPersonal.jsx
...
import './SecureHistorialPersonal.css'

const API_URL = import.meta.env.VITE_API_URL
const FILES_URL = API_URL.replace(/\/api\/?$/, '')

const SecureHistorialPersonal = ({ rutaRelativa, nombreArchivo }) => {
  ...
  const buildUrl = () => {
    ...
    const path = rutaRelativa.startsWith('uploads/')
      ? rutaRelativa
  ...
  const handleDownload = async () => {
    try {
      ...
      console.error(err)
      alert('No se pudo descargar el documento del historial.')
    } finally {
      setLoading(false)
    }
  }
...
export default SecureHistorialPersonal
