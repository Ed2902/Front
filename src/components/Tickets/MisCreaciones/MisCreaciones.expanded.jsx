// MisCreaciones.expanded.jsx
import React from 'react'
import { CatalogBadge, OrgBadge } from './MisCreaciones.badges.jsx'
import TrazabilidadEstado from './MisCreaciones.trazabilidad.jsx'
import {
...
export default function ExpandedComponent({
  ...
  const canEdit = !!canEditDelete && !cierreInfo.cerrado
  const canDelete = !!canEditDelete && !!data?.activo
