...
const EntradasPorCliente = ({ tipoProducto, mes, año }) => {
    ...
    const cargarDatos = async () => {
      try {
        ...
        datos.forEach(d => {
          ...
          if (esEntrada && esDelAnio && esDelMes && esDelTipo) {
        ...
        console.error('Error cargando entradas por cliente:', err)
      }
    }
  ...
  return (
    <div className='grafico-cliente'>
      <h3>Entradas por Cliente – Tipo: {tipoProducto}</h3>
...
export default EntradasPorCliente
